...
export class Item {
  ...
  @Length(MIN_VALUE_ID, MAX_VALUE_ID, {
    message: `The value of the item id must be between ${MIN_VALUE_ID} and ${MAX_VALUE_ID} characters`,
  })
  private id: string;
  ...
  @Length(MIN_VALUE_TITLE, MAX_VALUE_TITLE, {
    message: `The value of the item title must be between ${MIN_VALUE_TITLE} and ${MAX_VALUE_TITLE} characters`,
  })
  ...
  @Length(MIN_VALUE_DESCRIP, MAX_VALUE_DESCRIP, {
    message: `The value of the item description must be between ${MIN_VALUE_DESCRIP} and ${MAX_VALUE_DESCRIP} characters`,
  })
  ...
  @Length(MIN_VALUE_PICT_URL, MAX_VALUE_PICT_URL, {
    message: `The value of the item picture url must be between ${MIN_VALUE_PICT_URL} and ${MAX_VALUE_PICT_URL} characters`,
  })
  ...
  @Length(MIN_VALUE_CATEG_ID, MAX_VALUE_CATEG_ID, {
    message: `The value of the item category id must be between ${MIN_VALUE_CATEG_ID} and ${MAX_VALUE_CATEG_ID} characters`,
  })
  ...
  @Min(MIN_VALUE_QUANTITY, {
    message: "quantity item value must be greater than zero",
  })
  @Max(MAX_VALUE_QUANTITY, {
    message: `quantity item value must be less than ${MAX_VALUE_QUANTITY}`,
  })
  ...
  @IsNumber(
    ...
    {
      message:
        "The unit price of the item must be of type number (decimal) and contain only two decimal places after the separator",
    }
  )
  @Min(MIN_VALUE_UNIT_PRICE, {
    message: `The unit price of the item value must be greater than ${MIN_VALUE_UNIT_PRICE}`,
  })
  @Max(MAX_VALUE_UNIT_PRICE, {
    message: `The unit price of the item value must be less than ${MAX_VALUE_UNIT_PRICE}`,
  })
