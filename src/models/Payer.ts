...
export class Payer {
  ...
  @Length(MIN_VALUE_ID, MAX_VALUE_ID, {
    message: `The value of the id must be between ${MIN_VALUE_ID} and ${MAX_VALUE_ID} characters`,
  })
  private id: string;

  @IsNotEmpty({ message: "The first name cannot be empty" })
  @IsString({ message: "The first name must be of type string" })
  @Length(MIN_VALUE_FIRST_LASTNAME, MAX_VALUE_FIRST_LASTNAME, {
    message: `The value of the first name must be between ${MIN_VALUE_FIRST_LASTNAME} and ${MAX_VALUE_FIRST_LASTNAME} characters`,
  })
  ...
  @Length(MIN_VALUE_FIRST_LASTNAME, MAX_VALUE_FIRST_LASTNAME, {
    message: `The value of the last name must be between ${MIN_VALUE_FIRST_LASTNAME} and ${MAX_VALUE_FIRST_LASTNAME} characters`,
  })
